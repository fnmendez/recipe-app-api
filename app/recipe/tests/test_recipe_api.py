...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        ingredient_indian = Ingredient.objects.create(user=self.user, name="Lemon")
        payload = {
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        ingredient_lunch = Ingredient.objects.create(user=self.user, name="Potato")
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title="Posh Beeans on Toast")
